...
{% block content %}
	<div class="bdb-list clearfix">
		...
		<a href=""><i class="icon icon-02"></i>
			<div class="w-1">店铺活动</div>
		</a>
		<a href=""><i class="icon icon-03"></i>
			<div class="w-1">货架</div>
		</a>
		<a href=""><i class="icon icon-04"></i>
			<div class="w-1">平台活动</div>
		</a>
		<a href=""><i class="icon icon-05"></i>
			<div class="w-2">订单管理</div>
		</a>
		<a href="/store/manage"><i class="icon icon-06"></i>
			<div class="w-2">店铺</div>
		</a>
	</div>
