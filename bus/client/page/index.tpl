		...
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				<div class="bdb-list clearfix">
					<a href=""><i class="facial icon-01"></i>

						<div class="w-1">拍卖行</div>
					</a>
					<a href="/activity/store-activity"><i class="facial icon-02"></i>

						<div class="w-1">店铺活动</div>
					</a>
					<a href="/activity/bdb-activity">
						<i class="facial icon-03"></i>

						<div class="w-1">平台活动</div>
					</a>
					<a href="/store/manage">
						<i class="facial icon-04"></i>

						<div class="w-1">店铺</div>
					</a>
					<a href="">
						<i class="facial icon-05"></i>

						<div class="w-2">货架</div>
					</a>
					<a href="">
						<i class="facial icon-06"></i>
			...
			<div class="swiper-slide">
				<div class="bdb-list clearfix">
					<a href="/wallet"><i class="facial icon-07"></i>

						<div class="w-1">财务中心</div>
					</a>
					<a href="/activity/store-activity"><i class="facial icon-08"></i>

						<div class="w-1">客服中心</div>
					</a>
					<a href="/settings/sys-settings"><i class="facial icon-09"></i>
