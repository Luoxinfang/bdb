...
<div class="form">
	...
	<div class="form-group mt20">
		<div class="item icon-right input-wrap">
			...
			<span class="fr fc-2">￥<i data-role="input">5000</i></span>
			<input type="number" value="5000">
		</div>
		<div class="item icon-right input-wrap">
			<span class="fl">保证金</span>
			<span class="fr fc-2">￥<i data-role="input">100</i></span>
			<input type="number" value="100">
		</div>
		<div class="item icon-right input-wrap">
			<span class="fl">起拍价</span>
			<span class="fr fc-2">￥<i data-role="input">500</i></span>
			<input type="number" value="500">
		</div>
		<div class="item icon-right input-wrap">
			<span class="fl">加价幅度</span>
			<span class="fr fc-2">￥<i data-role="input">200</i></span>
			<input type="number" value="200">
		</div>
	</div>
	<p class="tip-sm">不能超过保证金金额，如果保证金金额为0则不能超过200元，截拍后此金额将会打赏给参拍用户！</p>
	<div class="form-group mt20">
	...
	<a href="/shelves/list" class="btn btn-red mt20">确定上架</a>
</div>
{% script %}
